...
from fetchlib.utils import Collection, BP, Classes
...
class Setup:
    ...
    def initial_collection(self):
        d = self.importer.component_by_classes
    ...
    def me_mods(self):
        return {
            ...
            Classes.BASIC_CAPITAL_SHIP: 0.94,
            Classes.BASIC_LARGE_SHIP: 0.94,
            Classes.BASIC_CAPITAL_COMPONENT: 0.948,
        }
